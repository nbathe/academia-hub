...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar drop-in">
      <div class="max-width">
        ...
        <ul class="menu">
          ...
          <li><a href="categories.php" class="menu-btn">Category</a></li>
          <li><a href="events.php" class="menu-btn">Events</a></li>
    ...
    <section class="home" id="home">
      <div class="max-width">
        ...
        <div class="home-content left" style="flex-direction: row">
          <div class="text-1 drop-in">Academia Hub</div>
          <div class="text-2 drop-in">Your Academic <section class="animation"> <div class="first"><div>Bridge</div></div>
            <div class="second"><div>Partner</div></div>
            <div class="third"><div>Support</div></div></section></div>
          <div class="text-3 drop-in">
          ...
          <!-- Contact me Button -->
          <div class="drop-in-2">  
          <a href="publish.php" style="margin-left: 80px;">Publish<i class="bx bx-send reg"></i></a> 
</div>
          <div
    ...
    <section class="project" id="project">
      <div class="max-width">
        <!-- Project Heading -->
        <h2 class="title">Get updates about upcoming..</h2>
